...
#subclass: SUV
    def __init__(self, make, year, price, pass_cap):
        Automobile.__init__(make,year,price, pass_cap)
        self.auto_pass_cap
...
#user input
    ...
    pass_cap=int(input('Enter SUV passenger capacity: '))

    suv1=SUV(make, year, price, pass_cap)
    #print data
    print('\nCar Inventory\n')
